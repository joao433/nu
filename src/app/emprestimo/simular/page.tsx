...
function SimularEmprestimoContent() {
...
function SimularEmprestimoContentSkeleton() {
  return (
    <section className="container mx-auto max-w-7xl px-4 py-16 md:py-24">
      <div className="mb-12 text-left">
        <Skeleton className="h-6 w-56 mb-2" />
        <Skeleton className="h-10 w-[450px] mb-4" />
  ...
  return (
    <div className="flex min-h-screen w-full flex-col bg-background">
      ...
      <main className="flex-1">
        <Suspense fallback={<SimularEmprestimoContentSkeleton />}>
          <SimularEmprestimoContent />
        </Suspense>
      </main>
    </div>
  );
